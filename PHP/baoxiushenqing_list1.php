...
//youzuiping2
  ...
  <tr>
    ...
    <td width="70" align="center">
	 <a href="baoxiushenqing_updtlb.php?id=<?php echo mysql_result($query,$i,"id");?>">反馈</a>	 </td>
  </tr>
  	<?php
	}
}
...
<p align="center"><a href="baoxiushenqing_list1.php?pagecurrent=1">首页</a>, <a href="baoxiushenqing_list1.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="baoxiushenqing_list1.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="baoxiushenqing_list1.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
</body>
</html>
