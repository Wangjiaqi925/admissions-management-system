...
//youzuiping2
  ...
  <tr>
    ...
    <td><?php echo mysql_result($query,$i,bianhao);?></td>    <td><?php echo mysql_result($query,$i,mingcheng);?></td>    <td><?php echo mysql_result($query,$i,leixing);?></td>    <td><?php echo mysql_result($query,$i,jiage);?></td>    <td width='80'><a href="<?php echo mysql_result($query,$i,tupian) ?>" target='_blank'><img src='<?php echo mysql_result($query,$i,tupian) ?>' width='80' height='88' border='0'></a></td>        <td><?php echo mysql_result($query,$i,yonghu);?></td>    <td width='80' align='center'><a href="sh.php?id=<?php echo mysql_result($query,$i,"id") ?>&yuan=<?php echo mysql_result($query,$i,"issh")?>&tablename=gonggongzichan" onclick="return confirm('您确定要执行此操作？')"><?php echo mysql_result($query,$i,"issh")?></a></td>
	<!--dpinglun2-->
    <td width="120" align="center"><?php echo mysql_result($query,$i,"addtime");?></td>
    <td width="120" align="center"><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=gonggongzichan" onclick="return confirm('真的要删除？')">删除</a> <a href="gonggongzichan_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a> <a href="gonggongzichan_detail.php?id=<?php echo mysql_result($query,$i,"id");?>">详细</a> </td>
  </tr>
  	<?php
	}
}
...
<p align="center"><a href="gonggongzichan_list.php?pagecurrent=1">首页</a>, <a href="gonggongzichan_list.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="gonggongzichan_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="gonggongzichan_list.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
<?php
