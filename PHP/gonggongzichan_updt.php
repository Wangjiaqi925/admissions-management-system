...
if ($addnew=="1" )
{
	...
	//lixandonxgjixelxb
	$sql="update gonggongzichan set bianhao='$bianhao',mingcheng='$mingcheng',leixing='$leixing',jiage='$jiage',tupian='$tupian',shuoming='$shuoming',yonghu='$yonghu' where id= ".$id;
	mysql_query($sql);
...
<!--hxsglxiangdxongjxs-->
<body>
<p>修改公共资产： 当前日期： <?php echo $ndate; ?></p>
<?php
