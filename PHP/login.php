...
//if($_POST['submit']){
	...
	if($login=="1")
	{
		...
		if($cx=="用户")
		{
			$sql="select * from yonghuxinxi where yonghuming='$username' and mima='$pwd' ";
		}
					...
					if($cx=="管理员")
		{
					...
					{
					$_SESSION['cx']=$cx;
					$_SESSION['xm']=mysql_result($query,0,"xingming");
					$_SESSION['bm']=mysql_result($query,0,"bumen");
					$_SESSION['sj']=mysql_result($query,0,"shouji");
