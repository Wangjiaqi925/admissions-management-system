...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
      ...
      <tr><td>姓名：</td><td><input name='xingming' type='text' id='xingming' value='<?php echo mysql_result($query,0,xingming);?>' readonly='readonly'  /></td></tr>
      ...
      <tr><td>部门：</td><td><input name='bumen' type='text' id='bumen' value='<?php echo mysql_result($query,0,bumen);?>' readonly='readonly'  /></td></tr>
